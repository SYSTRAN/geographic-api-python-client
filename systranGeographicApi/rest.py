...
try:
    ...
    raise ImportError('Systran python client requires urllib3.')
...
class RESTClientObject(object):
        ...
        if method in ['POST', 'PUT', 'PATCH']:
            ...
            if headers['Content-Type'] == 'application/json':
                if body:
                    ...
                    r = self.agent(url).request(method, url, headers=headers)
    ...
    def POST(self, url, headers=None, post_params=None, body=None, query_params=None):
        return self.request("POST", url, headers=headers, post_params=post_params, body=body, query_params=query_params)
