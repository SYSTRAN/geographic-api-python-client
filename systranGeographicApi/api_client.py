...
class ApiClient(object):
  """
  Generic API client for Systran client library builds
  ...
  def __init__(self, host=configuration.host, header_name=None, header_value=None):
    ...
    self.user_agent = 'Python-Systran'
  ...
  def call_api(self, resource_path, method, path_params=None, query_params=None, header_params=None,
    ...
    if query_params:
      ...
      query_params = {k: self.to_query_value(v) for k, v in iteritems(query_params)}
  ...
  def to_query_value(self, obj):
    """
    Convert a string or object to a query-friendly value
  ...
  def sanitize_for_serialization(self, obj):
    ...
    If obj is systran model, return the properties dict.
    """
    if isinstance(obj, type(None)):
      ...
      if isinstance(obj, dict):
        ...
        # Convert model obj to dict except attributes `systran_types`, `attribute_map`
        ...
        obj_dict = {obj.attribute_map[key]: val
                    ...
                    if key != 'systran_types' and key != 'attribute_map' and val is not None}
  ...
  def deserialize(self, obj, obj_class):
    ...
    # Do not derialize file content
    if obj_class in ['File', 'file']:
      return obj
    if type(obj_class) == str:
      ...
      if obj_class in ['int', 'float', 'dict', 'list', 'str', 'bool', 'datetime', 'object', 'Object']:
        if obj_class in ['object', 'Object']:
          obj_class = 'dict'
    ...
    for attr, attr_type in iteritems(instance.systran_types):
