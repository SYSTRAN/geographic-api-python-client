...
class DestinationsApi(object):
    ...
    def geographic_destinations_get_get(self, id, **kwargs):
        """
        Get a specific Destination
        Get a specific `Destination`.

        :param str id: Destination identifier (required)
        ...
        if id is None:
            raise ValueError("Missing the required parameter `id` when calling `geographic_destinations_get_get`")
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError("Got an unexpected keyword argument '%s' to method geographic_destinations_get_get" % key)
            params[key] = val
        del params['kwargs']

        resource_path = '/geographic/destinations/get'.replace('{format}', 'json')
        method = 'GET'
        ...
        response = self.api_client.call_api(resource_path, method, path_params, query_params, header_params,
                                            ...
                                            response='DestinationDetailsResponse', auth_settings=auth_settings)
        
        return response
        
    def geographic_destinations_list_get(self, **kwargs):
        """
        List Destinations
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError("Got an unexpected keyword argument '%s' to method geographic_destinations_list_get" % key)
            params[key] = val
        del params['kwargs']

        resource_path = '/geographic/destinations/list'.replace('{format}', 'json')
        method = 'GET'
        ...
        response = self.api_client.call_api(resource_path, method, path_params, query_params, header_params,
                                            body=body_params, post_params=form_params, files=files,
                                            response='DestinationResponse', auth_settings=auth_settings)
